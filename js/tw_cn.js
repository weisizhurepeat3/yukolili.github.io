...
document.addEventListener('DOMContentLoaded', function () {
    var t = GLOBAL_CONFIG.translate, e = GLOBAL_CONFIG.Snackbar, n = t.defaultEncoding, o = t.translateDelay, a = t.msgToTraditionalChinese, r = t.msgToSimplifiedChinese, c = n, l = 'translate-chn-cht', i = void 0 === saveToLocal.get(l) ? n : Number(saveToLocal.get('translate-chn-cht')), d = void 0, u = void 0 !== GLOBAL_CONFIG.Snackbar;
    function f(t) {
        return '' === t || null == t ? '' : 1 === c && 2 === i ? function (t) {
            for (var e = '', n = m(), o = v(), a = 0; a < t.length; a++)
                10000 < t.charCodeAt(a) && -1 !== o.indexOf(t.charAt(a)) ? e += n.charAt(o.indexOf(t.charAt(a))) : e += t.charAt(a);
            return e;
        }(t) : 2 === c && 1 === i ? function (t) {
            for (var e = '', n = m(), o = v(), a = 0; a < t.length; a++)
                10000 < t.charCodeAt(a) && -1 !== n.indexOf(t.charAt(a)) ? e += o.charAt(n.indexOf(t.charAt(a))) : e += t.charAt(a);
            return e;
        }(t) : t;
    }
    function h(t) {
        for (var e = void 0, e = ('object' === (void 0 === t ? 'undefined' : _typeof(t)) ? t : document.body).childNodes, n = 0; n < e.length; n++) {
            var o = e.item(n);
            0 < '||BR|HR|'.indexOf('|' + o.tagName + '|') || o === d || ('' !== o.title && null != o.title && (o.title = f(o.title)), '' !== o.alt && null != o.alt && (o.alt = f(o.alt)), '' !== o.placeholder && null != o.placeholder && (o.placeholder = f(o.placeholder)), 'INPUT' === o.tagName && '' !== o.value && 'text' !== o.type && 'hidden' !== o.type && (o.value = f(o.value)), 3 === o.nodeType ? o.data = f(o.data) : h(o));
        }
    }
    function s() {
        1 === i ? (c = 1, i = 2, d.innerHTML = a, saveToLocal.set(l, i, 2), h(), u && btf.snackbarShow(e.cht_to_chs)) : 2 === i && (c = 2, i = 1, d.innerHTML = r, saveToLocal.set(l, i, 2), h(), u && btf.snackbarShow(e.chs_to_cht));
    }
    function m() {
    ...
    function y() {
        (d = document.getElementById('translateLink')) && (c !== i && (setTimeout(h, o), d.innerHTML = 1 === i ? r : a), d.addEventListener('click', s, !1));
    }
    y(), document.addEventListener('pjax:complete', y);
});